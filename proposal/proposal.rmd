...
- **Class Info**: Visualizations on the number of people in courses and types of courses
...
- **Recommendations**: Based on inputted class schedule, the app will 
provide recommendations on where and when a student should study (based on how 
populated each building is?) and 
