...
author: "Seven of Hearts: Yihan, Kartik, Kate"
...
Create an R Shiny app that allows students to build their academic schedule and
...
schedule based on their selection. Specifically, we hope to create three visualizations
based on student class selection: 
	
- Course schedule in a calendar (classes colored based on student selection). If 
there is overlapping class times, an error will occur (visually). 
  
- Geo-spatial visualization showing the distance traveled during a specific day 
or week. 
	
- Visualization showing the population density in each building on campus during 
a given time.
...
between buildings. For convenience, buildings that are close to each other are 
grouped together.
...
### Weekly Plan of Attack
  ...
  - Week 3 of project (week of Mon, Nov 1): 
      + Kate:Request Course data from Registrar's office, 
      data cleanup. 
...
- Data folder contains 3 data sets and a README file: 
  ...
  + building_group.csv: The groups each building belongs to
