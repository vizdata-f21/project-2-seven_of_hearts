...
- **Class Info**: Visualzations on the number of people in courses and types of courses
...
```{r app_screenshot, echo=FALSE, fig.align='center', fig.cap='DukeHub 3.0'}
knitr::include_graphics(here::here("data/DukeHub3.0.png"))
```
...
### Weekly Plan of Attack
  ...
  - Week 8 of Project(Due Date): Present our project
    + All team members: practice presentation leading up to final presnetaiton. 
